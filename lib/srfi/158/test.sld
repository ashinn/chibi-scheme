  ...
  (begin
    ...
    (define (call-with-input-string string proc)
      (let ((port (open-input-string string)))
        ;; XXX: do not close the port when returning, because the
        ;; generator would be invalidated.
        (proc port)))
    ...
    (define (run-tests)
      ...
      (test-group "generators"
                  ...
                  (test-group "generators/operators"
                              ...
                              (define gsmall (make-range-generator 1 5))
                              (define (small? x) (< x 3))
                              (test '(1 2) (generator->list (gtake-while small? gsmall)))
                              (define gsmall2 (make-range-generator 1 5))
                              (test '(3 4) (generator->list (gdrop-while small? gsmall2)))
                  ...
                  (test-group "generators/consumers"
                              ...
                              (test '(e d c b a . z) (call-with-input-string "a b c d e"
                                                       (lambda (port) (generator-fold cons 'z (lambda () (read port))))))
                              ...
                              (test '(4) (generator->list g))
                              (define godd (make-range-generator 2 5))
                              (test #f (generator-every odd? godd))
                              (test '(3 4) (generator->list godd))
