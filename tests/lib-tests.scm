...
(import (scheme base)
        ...
        (rename (srfi 144 test) (run-tests run-srfi-144-tests))
        ...
        (rename (srfi 231 test) (run-tests run-srfi-231-tests))
        (rename (srfi 235 test) (run-tests run-srfi-235-tests))
        (rename (srfi 253 test) (run-tests run-srfi-253-tests))
