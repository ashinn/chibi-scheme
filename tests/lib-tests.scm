...
(import (scheme base)
        ...
        (rename (srfi 167 pack test) (run-tests run-srfi-167-pack-tests))
        (rename (srfi 167 memory test) (run-tests run-srfi-167-memory-tests))
        (rename (srfi 168 test) (run-tests run-srfi-168-tests))
        (rename (srfi 173 test) (run-tests run-srfi-173-tests))
...
(run-srfi-158-tests)
(run-srfi-160-tests)
(run-srfi-167-pack-tests)
(run-srfi-167-memory-tests)
(run-srfi-168-tests)
(run-srfi-173-tests)
(run-base64-tests)
